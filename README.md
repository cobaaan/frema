...
adminアカウント(管理者)  Email:jackson5@kingofpop.example Password:password  
userアカウント(一般ユーザー) Email:uncle-kerl@calbee.example Password:password  
<br>
...
##### 商品詳細取得
商品画像をクリックで商品詳細ページに移動、名前・ブランド・値段・商品説明・カテゴリー・商品の状態の情報、お気に入りボタン・コメントボタン・購入するボタンが表示される  
<br>
...
非ログイン状態では商品へのコメントは表示されますが、「商品へのコメント」入力欄と「コメントを送信する」ボタンは表示されません  
<br>
